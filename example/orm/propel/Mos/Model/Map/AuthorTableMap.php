...
use Mos\\Model\Author;
use Mos\\Model\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Mos..Model.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\Mos\\\\Model\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Mos..Model.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Mos\\\\Model\\Author');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Mos\\Model\Author) { // it's a model object
