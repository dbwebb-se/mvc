...
namespace Mos\\Model\Map;

use Mos\\Model\Book;
use Mos\\Model\BookQuery;
...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Mos..Model.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\Mos\\\\Model\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Mos..Model.Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Mos\\\\Model\\Book');
        $this->setPackage('Mos..Model');
    ...
    {
        $this->addRelation('Publisher', '\\Mos\\\\Model\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\Mos\\\\Model\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Mos\\Model\Book) { // it's a model object
