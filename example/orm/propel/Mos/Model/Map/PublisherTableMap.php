...
use Mos\\Model\Publisher;
use Mos\\Model\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Mos..Model.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\Mos\\\\Model\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Mos..Model.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Mos\\\\Model\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\Mos\\\\Model\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Mos\\Model\Publisher) { // it's a model object
