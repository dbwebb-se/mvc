 ...
 *
 *
 * @package    propel.generator.Mos..Model.Base
 */
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Mos\\\\Model\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of Mos\\Model\Base\Publisher object.
     */
     ...
     * @return $this|\Mos\\Model\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Mos\\\\Model\\Publisher'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Mos\\Model\Publisher
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Mos\\Model\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Mos\\Model\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Mos\\Model\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\Mos\\Model\Book');
    }
        ...
        if (null === $this->collBooks || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collBooks) {
                    ...
                    $collBooks->setModel('\Mos\\Model\Book');
