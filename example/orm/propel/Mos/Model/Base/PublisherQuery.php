...
use \Exception;
use \PDO;
use Mos\\Model\Publisher as ChildPublisher;
use Mos\\Model\PublisherQuery as ChildPublisherQuery;
use Mos\\Model\Map\PublisherTableMap;
 ...
 *
 * @method     \Mos\\Model\BookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Mos\\Model\Base\PublisherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Mos\\\\Model\\Publisher', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Mos\\Model\Book object
     *
     * @param \Mos\\Model\Book|ObjectCollection $book the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($book instanceof \Mos\\Model\Book) {
            return $this
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \Mos\\Model\Book or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Mos\\Model\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\Mos\\Model\BookQuery');
    }

    /**
     * Use the Book relation Book object
     *
     * @param callable(\Mos\\Model\BookQuery):\Mos\\Model\BookQuery $callable A function working on the related query
     *
