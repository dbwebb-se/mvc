...
abstract class Book implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Mos\\\\Model\\Map\\BookTableMap';
    ...
    /**
     * Initializes internal state of Mos\\Model\Base\Book object.
     */
     ...
     * @return $this|\Mos\\Model\Book The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Mos\\\\Model\\Book'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Mos\\Model\Book The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Mos\\Model\Book (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Mos\\Model\Book Clone of current object.
     * @throws PropelException
     */
