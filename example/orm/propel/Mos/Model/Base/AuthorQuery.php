...
use \Exception;
use \PDO;
use Mos\\Model\Author as ChildAuthor;
use Mos\\Model\AuthorQuery as ChildAuthorQuery;
use Mos\\Model\Map\AuthorTableMap;
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Mos\\Model\Base\AuthorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Mos\\\\Model\\Author', $modelAlias = null)
    {
