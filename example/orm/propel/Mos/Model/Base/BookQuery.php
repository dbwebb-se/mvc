...
namespace Mos\\Model\Base;

use \Exception;
use \PDO;
use Mos\\Model\Book as ChildBook;
use Mos\\Model\BookQuery as ChildBookQuery;
use Mos\\Model\Map\BookTableMap;
 ...
 *
 * @method     \Mos\\Model\PublisherQuery|\Mos\\Model\AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Mos\\Model\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Mos\\\\Model\\Book', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Mos\\Model\Publisher object
     *
     * @param \Mos\\Model\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($publisher instanceof \Mos\\Model\Publisher) {
            return $this
            ...
            throw new PropelException('filterByPublisher() only accepts arguments of type \Mos\\Model\Publisher or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Mos\\Model\PublisherQuery A secondary query class using the current class as primary query
     */
    public function usePublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Publisher', '\Mos\\Model\PublisherQuery');
    }

    /**
     * Use the Publisher relation Publisher object
     *
     * @param callable(\Mos\\Model\PublisherQuery):\Mos\\Model\PublisherQuery $callable A function working on the related query
     *
    ...
    /**
     * Filter the query by a related \Mos\\Model\Author object
     *
     * @param \Mos\\Model\Author|ObjectCollection $author The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($author instanceof \Mos\\Model\Author) {
            return $this
            ...
            throw new PropelException('filterByAuthor() only accepts arguments of type \Mos\\Model\Author or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Mos\\Model\AuthorQuery A secondary query class using the current class as primary query
     */
    public function useAuthorQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAuthor($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Author', '\Mos\\Model\AuthorQuery');
    }

    /**
     * Use the Author relation Author object
     *
     * @param callable(\Mos\\Model\AuthorQuery):\Mos\\Model\AuthorQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
